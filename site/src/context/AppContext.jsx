...
const MOBILE_THEME_BREAKPOINT = 768;
...
export const AppProvider = ({ children }) => {
  ...
  const effectiveTheme = isMobileWeb ? systemTheme : theme;
  const canToggleTheme = !isMobileWeb;
  ...
  }, [theme, effectiveTheme, isMobileWeb]);
